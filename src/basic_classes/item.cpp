...
string Item::get_name() { return name_; }

unsigned int Item::get_weight() { return weight_; }

void Item::execute() {}
void Item::put_item() { is_thrown_ = false; }
...
bool Item::get_is_trown() { return is_thrown_; }
char Item::GetChar() const { return symbol_; }
} // namespace game
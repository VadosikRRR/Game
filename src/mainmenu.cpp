...
void MainMenu::loadGame() {
  ...
  QStringList const saveFiles =
      savesDir.entryList(QStringList() << "*.txt", QDir::Files);
  ...
  bool ok = false;
  QString selectedSave = QInputDialog::getItem(
      this, "Load Game", "Select a saved game:", saveFiles, 0, false, &ok);
